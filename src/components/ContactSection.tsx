...
export default function ContactSection() {
    ...
    animate-[shine_4s_linear_infinite]"
                            ...
                            {/* Location Badge */}
                            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-white/10 bg-white/[0.03] backdrop-blur-md text-xs font-mono text-white/70">
                        ...
                        <div className="w-full max-w-md flex flex-col gap-3.5 my-2">
                            {/* Email Card */}
                            <a
                                href="mailto:pareshms2535@gmail.com"
                                className="group flex items-center justify-between p-4 rounded-2xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.07] hover:border-blue-400/40 backdrop-blur-xl transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.2)]"
                            >
                                <div className="flex items-center gap-3.5">
                                    <div className="w-11 h-11 rounded-xl bg-blue-500/10 border border-blue-400/20 flex items-center justify-center text-blue-400 group-hover:scale-105 transition-transform duration-300">
                                        <FaEnvelope size={18} />
                                    </div>
                                    <div className="text-left">
                                        <span className="text-[10px] uppercase font-mono tracking-[0.2em] text-white/40 block">Email Me</span>
                                        <span className="text-xs sm:text-sm font-semibold text-white/90 group-hover:text-blue-300 transition-colors">
                                            pareshms2535@gmail.com
                                        </span>
                                    </div>
                                </div>
                                <span className="text-xs font-mono text-white/40 group-hover:text-blue-400 transition-colors">↗</span>
                            </a>

                            {/* WhatsApp Card */}
                            <a
                                href="https://wa.me/918088360136?text=Hi%20Paresh%2C%20I%20saw%20your%20portfolio%20and%20would%20like%20to%20connect!"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group flex items-center justify-between p-4 rounded-2xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.07] hover:border-emerald-400/40 backdrop-blur-xl transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.2)]"
                            >
                                <div className="flex items-center gap-3.5">
                                    <div className="w-11 h-11 rounded-xl bg-emerald-500/10 border border-emerald-400/20 flex items-center justify-center text-emerald-400 group-hover:scale-105 transition-transform duration-300">
                                        <FaWhatsapp size={20} />
                                    </div>
                                    <div className="text-left">
                                        <span className="text-[10px] uppercase font-mono tracking-[0.2em] text-white/40 block">WhatsApp</span>
                                        <span className="text-xs sm:text-sm font-semibold text-white/90 group-hover:text-emerald-300 transition-colors">
                                            +91 80883 60136
                                        </span>
                                    </div>
                                </div>
                                <span className="text-xs font-mono text-white/40 group-hover:text-emerald-400 transition-colors">↗</span>
                            </a>
                        </div>

                        {/* Social Media Links */}
                        <div className="flex flex-col items-center lg:items-start gap-2.5">
                            <span className="text-[10px] uppercase font-mono tracking-[0.25em] text-white/40">Social Connect</span>
                            <div className="flex items-center justify-center lg:justify-start gap-3.5 flex-wrap">

                                {/* LinkedIn */}
                                <a
                                    href="https://www.linkedin.com/in/paresh-ms-30663a397"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="LinkedIn"
                                    className="group relative w-12 h-12 rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-blue-400/40 hover:bg-blue-500/10 hover:shadow-[0_0_25px_rgba(59,130,246,0.3)]"
                                >
                                    <FaLinkedinIn className="text-white/80 group-hover:text-blue-400 text-[18px] transition-all duration-300" />
                                </a>

                                {/* Instagram */}
                                <a
                                    href="https://instagram.com/paresh__manchale__"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="Instagram"
                                    className="group relative w-12 h-12 rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-pink-500/40 hover:bg-pink-500/10 hover:shadow-[0_0_25px_rgba(244,114,182,0.3)]"
                                >
                                    <FaInstagram className="text-white/80 group-hover:text-pink-400 text-[18px] transition-all duration-300" />
                                </a>

                                {/* GitHub */}
                                <a
                                    href="https://github.com/pareshms"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="GitHub"
                                    className="group relative w-12 h-12 rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-white/40 hover:bg-white/10 hover:shadow-[0_0_25px_rgba(255,255,255,0.25)]"
                                >
                                    <FaGithub className="text-white/80 group-hover:text-white text-[18px] transition-all duration-300" />
                                </a>
                                ...
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                    aria-label="WhatsApp"
                                    className="group relative w-12 h-12 rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-emerald-400/40 hover:bg-emerald-500/10 hover:shadow-[0_0_25px_rgba(16,185,129,0.3)]"
                                >
                                    <FaWhatsapp className="text-white/80 group-hover:text-emerald-400 text-[18px] transition-all duration-300" />
                                </a>
                                ...
                                <a
                                    ...
                                    className="group relative w-12 h-12 rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-blue-400/40 hover:bg-blue-500/10 hover:shadow-[0_0_25px_rgba(59,130,246,0.3)]"
                                >
                                    <FaEnvelope className="text-white/80 group-hover:text-blue-400 text-[18px] transition-all duration-300" />
                                </a>
                            </div>
                        </div>
                    </div>
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    hover:-translate-y-1.5 hover:scale-105 hover:border-blue-400/40"
                        >
                            <div
                                className="absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                                style={{
                                    background:
                                        "linear-gradient(45deg, #0077b5, #00a0dc, #38bdf8)",
                                }}
                            />

                            <div className="absolute inset-[1px] rounded-[19px] bg-[#0b0b12]/80" />
                            <div className="absolute -inset-6 blur-2xl transition-all duration-500 group-hover:bg-blue-500/20" />

                            <FaLinkedinIn className="relative z-10 text-[26px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-white" />
                        </a>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-mono tracking-[0.2em] uppercase text-white/40">
                        <Link to="/privacy" className="hover:text-white transition-colors duration-200 underline underline-offset-4 decoration-white/20 hover:decoration-white">
                            Privacy Policy
                        </Link>
                    </div>
                </div>
